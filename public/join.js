...
// Create an audio element and preload the audio
const buzzerSound = new Audio('https://drop.fra1.cdn.digitaloceanspaces.com/shared/buzz.mp3');
...
buzzer.addEventListener('click', (e) => {
  ...
  // Play the buzzer sound when the button is clicked
  buzzerSound.play();
});
